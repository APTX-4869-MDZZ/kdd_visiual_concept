...
#print("before setting, TFHUB_CACHE_DIR: ", os.environ["TFHUB_CACHE_DIR"])
if "TFHUB_CACHE_DIR" not in os.environ: 
    print("TFHUB_CACHE_DIR not in environ.")	
...
print("after setting, TFHUB_CACHE_DIR: ", os.environ["TFHUB_CACHE_DIR"])

cn_bert_path = "https://hub.tensorflow.google.cn/google/bert_chinese_L-12_H-768_A-12/1"
en_bert_path = "https://hub.tensorflow.google.cn/google/bert_uncased_L-12_H-768_A-12/1"
